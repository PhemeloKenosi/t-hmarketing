...
<div class="container">
    <div class="image-container">
      <img src="img/Product_3_-_Hanna_Irish_Flat_Cap_for_Men-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Irish Flat Cap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product3">
        <button onclick="addToCart('Irish Flat Cap', 750.00, 'product3', 'img/Product_3_-_Hanna_Irish_Flat_Cap_for_Men-removebg-preview.png')">Add to Cart</button>
      </div>
