...
<div class="container">
    ...
    <div class="details-container">
      <h2 class="product-title">Hanna Hat Herringbone</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product2">
        <button onclick="addToCart('Hanna Hat Herringbone', 500.00, 'product2', 'img/Hanna_hat_herringbone-removebg-preview.jpg')">Add to Cart</button>
      </div>
