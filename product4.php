...
<div class="container">
    <div class="image-container">
      <img src="img/Product_4_-_Newsboy_Cap_for_Men-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Hanna Newsboy Cap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product4">
        <button onclick="addToCart('Hanna Newsboy Cap', 750.00, 'product4', 'img/Product_4_-_Newsboy_Cap_for_Men-removebg-preview.png')">Add to Cart</button>
      </div>
