...
<div class="container">
    <div class="image-container">
      <img src="img/Product_9_-_Fiddler_Cap-removebg-preview.jpg" alt="Product 12">
    </div>
    <div class="details-container">
      <h2 class="product-title">Fiddlen Cap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product12">
        <button onclick="addToCart('Fiddlen Cap', 500.00, 'product12', 'img/Product_9_-_Fiddler_Cap-removebg-preview.png')">Add to Cart</button>
      </div>
      ...
      <div class="footer-columns">
        <div class="footer-column">
            ...
            <div  class="social-media-icons">
              <a style="text-align: center;" href="#"><i class="fab fa-facebook"></i></a>
