...
<div class="container">
    <div class="image-container">
      <img src="img/Product_15_-_Hanna_Hat_Donegal-removebg-preview (1).jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Hanna Hat Donegal</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product9">
        <button onclick="addToCart('Hanna Hat Donegal', 600.00, 'product9', 'img/Product_15_-_Hanna_Hat_Donegal-removebg-preview (1).png')">Add to Cart</button>
      </div>
