...
<div class="container">
    <div class="image-container">
      <img src="img/hanna_hat_-_Product_16-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Irish Multicoloured Patchwork Hanna Hat</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product5">
        <button onclick="addToCart('Irish Multicoloured Patchwork Hanna Hat', 500.00, 'product5', 'img/hanna_hat_-_Product_16-removebg-preview.png')">Add to Cart</button>
      </div>
