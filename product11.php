...
<div class="container">
    <div class="image-container">
      <img src="img/Product_12_-_Wigens_Wool_Baseball_Cap_with_EarFlaps-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Wigens Wool Baseball Cap With Ear Flaps</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product11">
        <button onclick="addToCart('Wigens Wool Baseball Cap With Ear Flaps', 500.00, 'product11', 'img/Product_12_-_Wigens_Wool_Baseball_Cap_with_EarFlaps-removebg-preview.png')">Add to Cart</button>
      </div>
