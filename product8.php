...
<div class="container">
    <div class="image-container">
      <img src="img/Irish_Hanna_hat_men_donegal_8_piece-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Irish Hanna Hat Donegal 8 piece</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product8">
        <button onclick="addToCart('Irish Hanna Hat Donegal 8 piece', 600.00, 'product8', 'img/Irish_Hanna_hat_men_donegal_8_piece-removebg-preview.png')">Add to Cart</button>
      </div>
