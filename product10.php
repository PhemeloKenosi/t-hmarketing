...
<div class="container">
    <div class="image-container">
      <img src="img/Product_16_-_Hanna_JP_Cap_Charcoal-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Hanna JP Cap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product10">
        <button onclick="addToCart('Hanna JP Cap', 700.00, 'product10', 'img/Product_16_-_Hanna_JP_Cap_Charcoal-removebg-preview.png')">Add to Cart</button>
      </div>
