...
<div class="container">
    ...
    <div class="details-container">
      <h2 class="product-title">Grey Hanna Irish Cap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product1">
        <button onclick="addToCart('Grey Hanna Irish Cap', 800, 'product1', 'img/Product_1_-_Hanna_Irish_Cap-removebg-preview.jpg')">Add to Cart</button>
      </div>
