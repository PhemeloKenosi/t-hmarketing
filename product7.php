...
<div class="container">
    <div class="image-container">
      <img src="img/Kenmont_winter_outdoor_cap_with_ear_flap-removebg-preview.jpg" alt="Product 1">
    </div>
    <div class="details-container">
      <h2 class="product-title">Kermont Winter Outdoor Cap With Ear Flap</h2>
      ...
      <div class="add-to-cart">
        <input type="number" min="1" value="1" id="product7">
        <button onclick="addToCart('Kermont Winter Outdoor Cap With Ear Flap', 700.00, 'product7', 'img/Kenmont_winter_outdoor_cap_with_ear_flap-removebg-preview.png')">Add to Cart</button>
      </div>
